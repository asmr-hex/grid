  ...
  : Layout("MicroGranny")
{
  ...
  samples = std::make_shared<GridSection>("MicroGrannySamples",
                                       layout.parse_grid_region("samples"));
  presets = std::make_shared<GridSection>("MicroGrannyPresets",
                                       layout.parse_grid_region("presets"));
  banks   = std::make_shared<GridSection>("MicroGrannyBanks",
